...
# at present, icd.data::icd9cm_hierarchy is derived from RTF parsing, a little
...
test_that("factors are in the right place", {
  expect_is(icd.data::icd9cm_hierarchy[["code"]],
...
test_that("some chapters are correct", {
  ...
  expect_equal(
    chaps[nrow(icd.data::icd9cm_hierarchy)],
  ...
  expect_equal(chaps[neoplasm_first_row - 1],
...
test_that("some sub-chapters are correct", {
  ...
  expect_equal(subchaps[nrow(icd.data::icd9cm_hierarchy)],
    ...
    unname(
      vapply(
        icd.data::icd9cm_hierarchy[
          icd.data::icd9cm_hierarchy[["code"]] == "5060", ],
...
test_that("tricky v91.9 works", {
  expect_equal(
    icd.data::icd9cm_hierarchy[
      icd.data::icd9cm_hierarchy[["code"]] == "V9192", "long_desc"],
